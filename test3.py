...
def create_ascii_image(ascii_str, img_shape, font_scale=0.5, thickness=1):
    ...
    ascii_img = np.zeros((img_shape[0]*15, img_shape[1]*8, 3), dtype=np.uint8)
    ...
    # Draw each line of ASCII text in WHITE
    for line in lines:
...
def main():
    ...
    try:
        while True:
            ...
            # Create ASCII image with dark background and white text
